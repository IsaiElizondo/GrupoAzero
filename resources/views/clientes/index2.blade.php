                                ...
                                <tbody>
                                    @foreach($clientes as $cliente)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{route('clientes.edit', $cliente->id)}}" class="btn btn-primary btn-link btn-sm">
                                                    <span class="material-icons">edit</span>
                                                </a>
                                            </td>
                                            <td>
                                                <a href="#" class="btn btn-danger btn-link btn-sm" onclick="event.preventDefault();
                                                    if(confirm('¿Seguro que quier eliminar este cliente?')){
