...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
      ...
      <!-- CSS Files -->
      <link href="{{ asset('material') }}/css/material-dashboard.css?v=2.1.1&xqcd=453" rel="stylesheet" />
      <!-- CSS Just for demo purpose, don't include it in your project -->
      <link href="{{ asset('material') }}/demo/demo.css?xqcd=453" rel="stylesheet" />
